...
<template>
  <div class="listOfResponsesInProfile">
    <RouterLink v-for="response of listOfResponse" :key="response.id" to="" @click="changeRoute('/private/question'+response.question,'question',response.question)" >
      <div>
        <div class="decoration"></div>
        <span>{{ response.question_data.title }}</span>
      </div>
      <div>
